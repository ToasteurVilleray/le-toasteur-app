...
const TestimonialsMarquee = ({ slice }) => (
	<section className="my-20 mb-48">
		...
		<div className="mt-10 relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg ">
			...
			<div className="pointer-events-none absolute inset-y-0 left-0 w-1/3 bg-gradient-to-r dark:from-white from-white" />
			<div className="pointer-events-none absolute inset-y-0 right-0 w-1/3 bg-gradient-to-l dark:from-white from-white" />
		</div>
	</section>
);
